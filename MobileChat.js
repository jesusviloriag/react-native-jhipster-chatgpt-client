...
class MobileChat {
    ...
    static init(props) {
        if(!this.instance) {
            this.instance = new MobileChatService();
    ...
    static login(username, password) {
        ...
        return fetch(backendUrl + "authenticate", {
            ...
            .then((responseJson) => {
                ...
                _this.instance =  new MobileChatService();
                ...
                return fetch(backendUrl + 'account',{
                    ...
                    .then((responseJson) => {
                        ...
                        if((responseJson)&&(responseJson.login)){
                            ...
                            AsyncStorage.setItem('@userstore:token',MobileChat.instance.token);
                            MobileChat.instance.user = responseJson;
                            MobileChat.instance.userEdited = true;
...
class MobileChatService {
    ...
    async getAllUserChats() {
        let _this = this;
        return fetch(backendUrl + 'chats/user?page=0&size=20&sort=id,desc',{
            method: 'GET',
            headers: {
                Accept: 'application/json',
                'Content-Type': 'application/json',
